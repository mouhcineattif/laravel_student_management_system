<x-master title="Add Student">
    ...
    <form action="{{ route('students.update',$student->id) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="filiere" class="form-control" placeholder="job" value="{{ old('filiere',$student->filiere) }}"/>
        </div>
        <div class="mb-3">
            <label  class="form-label">Date Of Birth</label>
            <input
            type="date" name="date_de_naissance" value="{{ old('name',$student->date_de_naissance) }}" class="form-control"/>
        ...
        <div class="mb-3">
            ...
            <input
                type="text" name="massar" value="{{ old('massar',$student->massar) }}" class="form-control" placeholder="code"/>
                <small id="helpId" class="text-danger">
                    @error('massar')
                        {{$message}}
                    @enderror
